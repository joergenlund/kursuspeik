...
Export-NAVApplicationObject -DatabaseServer 'localhost' -DatabaseName 'Demo Database NAV (11-0)' -Filter 'Type=Page;Id=20..21' -Path 'c:\temp\Al\Objects.txt' -Username 'Admin' -Password 'Passw0rd'
